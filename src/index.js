...
app.post("/app", (req, res) => {
  ...
  tache1.createTache({
    nom: "README",
    description: "Redaction du README",
    dateDebut: "2024-03-23",
    dateFin: "2024-05-23",
    statut: "Status",
    priorite: "Haut",
  });
  ...
  tache3.editTache({
    nom: "Maquette",
    description: "Disigner l'application",
    dateDebut: "2024-03-23",
    dateFin: "2024-05-23",
    statut: "Status",
    priorite: "Haut",
  ...
  Assignation.assignerTache({
    employe: emlpoye1.getEmploye(),
    tache: tache2.getTache(),
  });
  Assignation.assignerTache({
    employe: emlpoye2.getEmploye(),
    tache: tache1.getTache(),
  });
